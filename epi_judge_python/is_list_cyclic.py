...
def has_cycle(head: ListNode) -> Optional[ListNode]:
    dummy_head = list_iterator1 = list_iterator2 = ListNode(0, head)

    while list_iterator2.next:
        list_iterator1 = list_iterator1.next
        list_iterator2 = list_iterator2.next.next
        if not list_iterator2:
            return None
        if list_iterator1 is list_iterator2:
            list_iterator1 = dummy_head
            while list_iterator1 is not list_iterator2:
                list_iterator1 = list_iterator1.next
                list_iterator2 = list_iterator2.next
            return list_iterator1
    return None
